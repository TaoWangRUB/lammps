...
PairStyle(nn/angular3,PairNNAngular3)

#else

#ifndef LMP_PAIR_NN_ANGULAR3_H
#define LMP_PAIR_NN_ANGULAR3_H
...
class PairNNAngular3 : public Pair {
 public:
  PairNNAngular3(class LAMMPS *);
  virtual ~PairNNAngular3();
  ...
  double dG2dR(double Rij, double eta, double Rc, double Rs);
  void dG4dR(double Rij, double Rik, double Rjk, 
